    ...
    return (
        <div className="w-full flex flex-col overflow-x-scroll">
            <div className="w-[800px] flex justify-center overflow-x-scroll">
                {recipeCardData.map((r, idx) => (
                    <div className="mr-8 relative flex items-center justify-center" key={idx}>
                        <img src={r.catImg} alt="cat_image" className="rounded-xl h-full object-cover" />
