    ...
    return (
        <div className='w-full h-full p-6'>
            ...
            <div className="top md:hidden">
                <div  className='flex justify-between items-center'>
                    <div>
                        ...
                        <p className='text-gray-400 text-xl leading-10 xs:text-l'>What do you want to cook today?</p>
                    </div>
                    <Link to='/add-recipe'>
                ...
                <div className="search mt-6">
                    <form onSubmit={onSubmitSearch} className='flex items-center xs:p-2 p-4 border rounded-full shadow hover:shadow-xl'>
            ...
            <div className="sm:hidden md:flex">
                ...
                <div className='absolute w-full h-full text-gray-200  bg-black/30 lg:h-[400px] xl:h-[490px] flex flex-col justify-center'>
                </div>
                    <img src='https://images.unsplash.com/photo-1543353071-087092ec393a?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80' alt="" className='h-[450px] w-full object-fill lg:h-[400px] xl:h-[490px]' />
                    <div className="flex lg:justify-center items-center">
                        <div  className='w-full flex flex-col ml-10 absolute top-[20%] lg:items-center'>
                            <h1 className='font-bold text-5xl text-gold lg:text-6xl'>Hello {userDetails?.userName?.split(" ")[0]},</h1>
                            <p className='text-gray-200 text-2xl leading-10 mt-6 lg:text-3xl'>What do you want to cook today?</p>
                        </div>
                        <div className="search absolute top-[50%] ml-8 mt-[40px]">
                            <form  onSubmit={onSubmitSearch} className='flex items-center p-2 border rounded-full hover:shadow-xl bg-white w-[500px] shadow-inner lg:w-[600px] xl:w-[700px] '>
                                <BsSearch  className='text-lg lg:text-2xl lg:ml-4'/>
                                <input type="text" className='ml-4 w-full lg:text-xl'placeholder='Search Recipes, Ingredients, etc.' value={searchInput} onChange={(e) => {
                                setSearchInput(e.target.value)
                            }}/>
                                <button type="submit" className="text-sm  p-2 border rounded-full bg-gold text-white lg:p-2">Submit</button>
                            </form>
                        </div>
                    </div>
                </div>
