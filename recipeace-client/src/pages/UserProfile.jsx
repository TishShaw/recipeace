            ...
            <div className="flex flex-col pb-5 w-full">
                <div className="relative flex flex-col mb-7">
                    <div className="flex flex-col just-center items-center">
                        ...
                        <img src={image?.asset?._ref ? (urlFor(image).url()) : 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT75n1LQI0BSnggENQz554GEkiD5DgoaBztVHcLOdmPmgbX9GMznoAdJ6FerzduRy5s5yk&usqp=CAU'} className=' absolute md:top-36 rounded-full object-cover w-[90px] h-[90px] shadow-xl xs:top-12 md:w-[120px] md:h-[120px] lg:top-30 sm:top-20 lg:h-[130px] lg:w-[130px] xl:w-[150px]' alt='userImg'/>
